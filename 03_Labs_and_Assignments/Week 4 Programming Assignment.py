...
def get_checkpoint_best_only():
    ...
    checkpoint_best_only = tf.keras.callbacks.ModelCheckpoint(
        filepath=checkpoint_path,
...
def get_model_last_epoch(model):
    """
    This function should create and return a new instance of the model which has
    loaded the weights from the latest training epoch.
    """
    checkpoint_path = tf.train.latest_checkpoint('checkpoints_every_epoch')
...
def get_model_best_epoch(model):
    """
    This function should create and return a new instance of the model which has
    loaded the weights from the best training epoch.
    """
    checkpoint_path = tf.train.latest_checkpoint('checkpoints_best_only')
    model.load_weights(checkpoint_path)
    return model  
